                ...
                <div className="grid sm:grid-cols-2 gap-4">
                  <div className="relative mt-6">
                    <input
                      ...
                      className={`peer w-full px-4 py-2 border rounded-lg contact-field-placeholder focus:outline-none focus:ring-2 focus:ring-orange-400 focus:border-transparent ${errors.firstName ? 'border-red-500' : 'border-gray-300'}`}
                    />
                    <label
                      htmlFor="firstName"
