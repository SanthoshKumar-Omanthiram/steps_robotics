...
import { Clock, Calendar,Share2, Plus, Facebook, Twitter, Instagram, Linkedin } from 'lucide-react';
        ...
        <div className="flex flex-col md:flex-row">
          <div className="w-full md:w-[70%]">
            <div className="mb-4">
             ...
             <div className="bg-white rounded-tr-[0px] rounded-tl-[0px]  rounded-bl-[15px] rounded-br-[15px] pt-[10px] pb-[20px] pl-[25px] pr-[20px] shadow-sm">
      ...
      <div>
        ...
        <div className="bootcamp-details-description">10:00 AM – 4:00 PM (includes snack breaks)</div>
            ...
            <div className='pb-[30px]'>
             ...
             <div className="bg-white rounded-tr-[0px] rounded-tl-[0px]  rounded-bl-[15px] rounded-br-[15px] pt-[10px] pb-[20px] pl-[25px] pr-[20px] shadow-sm">
                <div className="flex items-start pt-[5px] gap-3">
                  <span className="text-orange-500 -mt-[10px] text-xl font-bold">→</span>
                  <span className="bootcamp-details-description">Robotics hardware kit access (During boot camp)</span>
                </div>
                <div className="flex items-start pt-[5px] gap-3">
                  <span className="text-orange-500 -mt-[10px] text-xl font-bold">→</span>
                  <span className="bootcamp-details-description">Completion Certificate & Awards</span>
                </div>
                <div className="flex items-start pt-[5px] gap-3">
                  <span className="text-orange-500 -mt-[10px] text-xl font-bold">→</span>
                  <span className="bootcamp-details-description">Exclusive STEPS Boot Camp Badge</span>
                </div>
                <div className="flex items-start pt-[5px] gap-3">
                  <span className="text-orange-500 -mt-[10px] text-xl font-bold">→</span>
                  <span className="bootcamp-details-description">Light refreshments provided both days</span>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="bg-white rounded-lg overflow-hidden shadow-sm">
              ...
              {activeTab === 'course' && (
                <div className="p-6 space-y-3">
                  ...
                  {[
                    'Module 2: Unlocking the Coder System',
