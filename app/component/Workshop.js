...
export default function Workshop() {
  ...
  return (
    <section className="w-full program-workshop py-14">
      ...
      <Link href="/programs" className="border-hr-text hover:text-yellow-500 transition">Programs</Link>
      <span className="mx-2 border-hr-text">›</span>
      <Link href="#" className="text-yellow-500 border-hr-text">VEX GO Robotics Workshop Program</Link>
    </div>
...
/>
    ...
    />
            ...
            <div className="bg-[#FFFDF7] p-6 md:p-5 rounded-2xl shadow-[4px_-4px_10px_rgba(0,0,0,0.08)] border border-gray-100">
...
<hr className="border-b-2 border-hr border-yellow-400" />
  ...
  <path d="M6.875 11.1428H24.375M9.13691 3.75V5.6788M21.875 3.75V5.67856M21.875 5.67856H9.375C7.30393 5.67856 5.625 7.40545 5.625 9.53568V22.3929C5.625 24.5231 7.30393 26.25 9.375 26.25H21.875C23.9461 26.25 25.625 24.5231 25.625 22.3929L25.625 9.53568C25.625 7.40545 23.9461 5.67856 21.875 5.67856ZM14.375 16.9286L16.25 15V21.4285M16.25 21.4285H14.375M16.25 21.4285H18.125" stroke="#EF9E08" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
</svg>
                  <div>
                ...
                <div className="flex items-center gap-2">
                  <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
  <path d="M18.2812 17.8125L14.0625 16.4062V10.5261M25.3125 15C25.3125 8.7868 20.2757 3.75 14.0625 3.75C7.8493 3.75 2.8125 8.7868 2.8125 15C2.8125 21.2132 7.8493 26.25 14.0625 26.25C18.2266 26.25 21.8623 23.9876 23.8074 20.625M22.2263 13.7654L25.0388 16.5779L27.8513 13.7654" stroke="#EF9E08" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
</svg>
                  <div>
  ...
  <path d="M19.5275 18.7612C20.0515 18.9358 20.6178 18.6527 20.7924 18.1287C20.9671 17.6048 20.6839 17.0385 20.16 16.8638L19.8438 17.8125L19.5275 18.7612ZM15.625 16.4062H14.625C14.625 16.8367 14.9004 17.2188 15.3088 17.3549L15.625 16.4062ZM16.625 10.5261C16.625 9.9738 16.1773 9.52609 15.625 9.52609C15.0727 9.52609 14.625 9.9738 14.625 10.5261H15.625H16.625ZM19.8438 17.8125L20.16 16.8638L15.9412 15.4576L15.625 16.4062L15.3088 17.3549L19.5275 18.7612L19.8438 17.8125ZM15.625 16.4062H16.625V10.5261H15.625H14.625V16.4062H15.625ZM26.875 15H25.875C25.875 20.6609 21.2859 25.25 15.625 25.25V26.25V27.25C22.3905 27.25 27.875 21.7655 27.875 15H26.875ZM15.625 26.25V25.25C9.96408 25.25 5.375 20.6609 5.375 15H4.375H3.375C3.375 21.7655 8.85951 27.25 15.625 27.25V26.25ZM4.375 15H5.375C5.375 9.33908 9.96408 4.75 15.625 4.75V3.75V2.75C8.85951 2.75 3.375 8.23451 3.375 15H4.375ZM15.625 3.75V4.75C21.2859 4.75 25.875 9.33908 25.875 15H26.875H27.875C27.875 8.23451 22.3905 2.75 15.625 2.75V3.75Z" fill="#EF9E08"/>
              ...
              <div className="mb-6">
                <div className="flex items-start gap-2">
                 <svg width="50" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
  <g clipPath="url(#clip0_8125_2510)">
    <path d="M26.25 12.5C26.25 21.25 15 28.75 15 28.75C15 28.75 3.75 21.25 3.75 12.5C3.75 9.51631 4.93526 6.65483 7.04505 4.54505C9.15483 2.43526 12.0163 1.25 15 1.25C17.9837 1.25 20.8452 2.43526 22.955 4.54505C25.0647 6.65483 26.25 9.51631 26.25 12.5Z" stroke="#EF9E08" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
    <path d="M15 16.25C17.0711 16.25 18.75 14.5711 18.75 12.5C18.75 10.4289 17.0711 8.75 15 8.75C12.9289 8.75 11.25 10.4289 11.25 12.5C11.25 14.5711 12.9289 16.25 15 16.25Z" stroke="#EF9E08" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
  </g>
  <defs>
    <clipPath id="clip0_8125_2510">
      <rect width="30" height="30" fill="white"/>
          ...
          <p className="text-[14px] event-details-span text-sm leading-snug">
            {program?.materials || "VEX GO robotics kits provided for every participant"}
          </p>
        </div>
              </div>
          ...
          <p className="text-[14px] event-details-span text-sm leading-snug">
            {program?.mentors || "VEX GO robotics kits provided for every participant"}
          </p>
        </div>
              </div>
          ...
          <p className="text-[14px] event-details-span text-sm leading-snug">
            {program?.batch_size || "VEX GO robotics kits provided for every participant"}
          </p>
        </div>
              </div>
